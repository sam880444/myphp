...
try {
    ...
    //$query = "select ModelNumber,ModelName from Products";
    $query = "select Products.*,Categories.CategoryName from Products,Categories where Products.CategoryID=Categories.CategoryID";
